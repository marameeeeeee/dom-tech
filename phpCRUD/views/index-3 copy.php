...
<html class="no-js" lang="zxx">
  ...
  <body>
        ...
        <div class="offcanvas__wrapper">
          <div class="offcanvas__content">
            ...
            <div class="offcanvas__user mb-30 d-xxl-none">
              <div class="user__acount">
                ...
                <div class="user__name-mail">
                  <h4 class="user__name">
                    <a href="javascript:void(0)">Johnson</a>
                  </h4>
            ...
            <div class="offcanvas__btn mb-30">
              <a class="ms-border-btn" href="login.php"
                ><i class="fa-solid fa-plus"></i>Autentifier</a
              >
            </div>
    ...
    <!-- search popup start -->
    <div class="search__popup ms-border3">
      <div class="container">
        <div class="row">
    ...
    <header>
      <div
        class="ms-header3 ms-header3-space zindex-500 p-relative ms-header-fixed"
      >
        <div
          class="ms-header3-wrap d-flex align-items-center justify-content-between"
        >
          <div class="ms-header3-item">
            <div class="d-flex align-items-center">
              <div class="ms-header-search p-relative d-none d-xl-block mr-30">
                <form>
                  <input type="text" placeholder="Search" />
                  <button type="submit"><i class="flaticon-loupe"></i></button>
                </form>
              </div>
              <div class="ml-nl-logo ms-mw-142 d-xl-none m-img mr-50">
                <a href="index.html"
                  ><img src="assets/img/logo/footer-logo.png" alt="logo"
                /></a>
              </div>
              <div class="d-none d-xl-block">
                <div class="ms-header-social mb-10">
                  <a
          ...
          <div>
            <a class="ms-border-btn d-none d-xl-block" href="login.php"
              ><i class="fa-solid fa-plus"></i> En savoir plus</a
            >
           
            <a class="ms-profile-btn ml-30 d-none d-xl-block" href="#"
              ><i class="flaticon-user"></i
            ></a>
            <a
              href="javascript:void(0)"
              class="ms-dot-toggle ml-30 ms-cp sidebar__toggle d-xl-none"
            >
              <img src="assets/img/header/menu-dot.png" alt="menu dot" />
            </a>
          </div>
        </div>
      </div>
      <div class="ms-header3-menu d-none">
            ...
            <nav id="mobile-menu2">
              <ul>
                <li class="has-dropdown">
                  ...
                  <ul class="submenu">
                    ...
                    <li class="has-dropdown">
                      ...
                      <ul class="submenu">
                        <li><a href="index-rtl.html">Home Style 01 RTL</a></li>
                        <li>
                          <a href="index-2-rtl.html">Home Style 02 RTL</a>
                        </li>
                        <li>
                          <a href="index-3-rtl.html">Home Style 03 RTL</a>
                        </li>
                      </ul>
                    </li>
                  </ul>
                ...
                <li class="has-dropdown has-mega-menu">
                  ...
                  <ul class="mega-menu">
                    <li>
                      <a href="javasript:void(0);" class="mega-menu-title"
                        >Page Layout 1</a
                      >
                      <ul>
                        <li><a href="index.html">Home Style 01</a></li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="genres-details.html">genres details</a>
                        </li>
                        <li><a href="team.html">Team</a></li>
                        <li><a href="team-details.html">team details</a></li>
                        <li><a href="enquiry-list.html">enquiry list</a></li>
                    ...
                    <li>
                      ...
                      <ul>
                        ...
                        <li><a href="ideas-advice.html">ideas advice</a></li>
                        <li>
                          <a href="ideas-advice-details.html"
                            >ideas advice details</a
                          >
                        </li>
                        <li><a href="news.html">blog</a></li>
                        <li><a href="news-details.html">blog details</a></li>
                        <li><a href="addUser.php">Join Us</a></li>
                      </ul>
                    </li>
                    <li>
                      <a href="javasript:void(0);" class="mega-menu-title"
    ...
    <div
      id="header-sticky"
      class="ms-header3 ms-header-fixed ms-header3-sticky ms-header-fixed ms-header4-space zindex-500 p-relative"
    >
      <div
        class="ms-header3-wrap d-flex align-items-center justify-content-between"
      >
        <div class="ms-header3-item">
          <div class="d-flex align-items-center">
            <div class="ml-nl-logo ms-mw-142 m-img mr-50">
              <a href="index.html"
                ><img src="assets/img/logo/footer-logo.png" alt="logo"
              /></a>
            </div>
        ...
        <div class="ms-header3-item d-flex align-items-center">
          <a class="ms-border-btn d-none d-xl-block" href="addUser.php"
            ><i class="fa-solid fa-plus"></i> List Your Service</a
          >
          <a class="ms-profile-btn ml-30 d-none d-xl-block" href="#"
            ><i class="flaticon-user"></i
          ></a>
          <a
            href="javascript:void(0)"
            class="ms-dot-toggle ml-30 ms-cp sidebar__toggle"
          >
            <img src="assets/img/header/menu-dot.png" alt="menu dot" />
          </a>
        </div>
    ...
    <div class="ms-all-content pt-0">
      <main>
        <!-- Banner 3 Area Start Here  -->
        <div class="ms-banner3-area fix pl-40 pr-40 mb-0">
          <div
            class="ms-banner3-item-wrap ms-mih-400 d-flex align-items-center justify-content-center"
          >
            <div class="ms-banner3-item d-none d-lg-block">
              <div class="ms-banner3-img1 ms-opacity-2 p-relative m-img">
                <div class="ms-overlay2 p-absolute"></div>
                <img src="fond3.png" alt="banner image" />
              </div>
            </div>
            <div class="ms-banner3-item">
              <div class="ms-banner3-img2 m-img p-relative">
                <img src="fond.png" alt="banner image" />
                <div class="ms-banner3-round zindex--1 p-absolute m-img">
                  <img src="fond4.png" alt="banner round shape" />
                </div>
              </div>
            </div>
            <div class="ms-banner3-item d-none d-lg-block">
              <div class="ms-banner3-img3 ms-opacity-2 p-relative m-img">
                <div class="ms-overlay2 p-absolute"></div>
                <img src="fond2.jpg" alt="banner image" />
              </div>
            </div>
          </div>
        </div>
        <!-- Banner 3 Area End Here  -->

        <!-- Navigation Area Start Here  -->
        <div class="ms-navigation-area fix">
          <div class="ms-navigation-wrap ms-bg-3">
            <div class="d-none d-xl-block">
              <div class="ms-nl-wrap ms-bg-5">
                <div class="ms-nl-item">
                  <div class="ml-nl-logo ms-mw-142 m-img">
                    <a href="index.html"
                      ><img src="assets/img/logo/footer-logo.png" alt="logo"
                    /></a>
                  </div>
                ...
                <div class="ms-nl-item">
                  <div class="ms-dot-toggle ms-cp sidebar__toggle">
                    <img src="assets/img/header/menu-dot.png" alt="menu dot" />
                  </div>
                </div>
                <div class="ms-nl-item">
                  <div class="ms-nl-search">
                    <a class="ms-search-btn" href="#"
                      ><i class="flaticon-loupe"></i> Find Acts</a
                    >
                  </div>
                </div>
              </div>
            </div>
            <div class="ms-navigation-slider">
              <div class="ms-ns-active">
                <div class="ms-ns-slick">
                  <h3 class="ms-ns-title ms-text-stroke">
                    <a href="#">GUITARE</a>
                  </h3>
                </div>
                <div class="ms-ns-slick">
        ...
        <!-- work area start -->
        <section
          class="work__area work-overlay pt-130 pb-70 include__bg"
                ...
                >
                  <div class="ms-work3-inner">
                    <div class="ms-work3-thumb m-img p-relative fix ms-br-20">
                      ...
                      <img src="footer-logo.png" alt="work image" />
                    </div>
                    <div class="work__features-bottom ms-work3-features pb-0">
                      <div class="work__features-action">
                        <div class="work__features-btn ms-work3-feature-btn">
                          <a class="ms-fill-btn" href="contact.html"
                            >Premiér pas</a
                          >
                        </div>
                  ...
                  <div class="work__features-inner">
                    <div class="work__features-item">
                      ...
                      <div class="work__features-content">
                        ...
                        <p>
                          Compare rates and availability <br />
                          of local entertainers
                        </p>
                      </div>
                    </div>
                    <div class="work__features-item">
                      ...
                      <div class="work__features-content">
                        <h4>Book securely.</h4>
                        <p>
                          Booking through GigSalad <br />
                          ensures payment protection.
                        </p>
                      </div>
                    </div>
                    <div class="work__features-item">
                      ...
                      <div class="work__features-content">
                        ...
                        <p>
                          ...
                          your party come to life.
                        </p>
                      </div>
                    </div>
                  </div>
                  <div class="work__thumb-card ms-work3-card">
        ...
        <!-- Popular  area start -->
        <section
          class="ms-popular__area pt-130 pb-100 p-relative include__bg"
        ...
        >
          ...
          <div class="container">
            <div class="row align-items-end mb-25 bdFadeUp">
              ...
              <div class="col-lg-6">
                <div
                  class="ms-popular__tab p-relative zindex-1 ms-popular-flex mb-40"
                >
                  <nav>
              ...
              <div class="col-xxl-12">
                <div class="tab-content" id="nav-tabContent">
                  <div
                    ...
                    tabindex="0"
                  >
                    <div class="swiper-container ms-popular2-active">
                          ...
                          <div class="ms-popular__item p-relative mb-30">
                            <div class="ms-popular__thumb">
                              ...
                              <a href="genres-details.html"
                                ><img src="01.png" alt="popular band"
                              /></a>
                              <a
                                href="genres-details.html"
                                class="ms-popular__link"
                              >
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Singers</a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            <div class="ms-popular__thumb">
                              <div class="ms-popular-overlay"></div>
                              <a href="genres-details.html"
                                ><img src="02.png" alt="popular band"
                              /></a>
                              <a
                                href="genres-details.html"
                                class="ms-popular__link"
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Bands & Group</a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            <div class="ms-popular__thumb">
                              <div class="ms-popular-overlay"></div>
                              <a href="genres-details.html"
                                ><img src="03.png" alt="popular band"
                              /></a>
                              <a
                                href="genres-details.html"
                                class="ms-popular__link"
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Tributes</a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            <div class="ms-popular__thumb">
                              <div class="ms-popular-overlay"></div>
                              <a href="genres-details.html"
                                ><img src="04.png" alt="popular band"
                              /></a>
                              <a
                                href="genres-details.html"
                                class="ms-popular__link"
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Solo Musicians </a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                      ...
                      <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            <div class="ms-popular__thumb">
                              <div class="ms-popular-overlay"></div>
                              <a href="genres-details.html"
                                ><img src="4.png" alt="popular band"
                              /></a>
                              <a
                                href="genres-details.html"
                                class="ms-popular__link"
                        ...
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Instrument1</a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Instrument2</a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Instrument3</a>
                            </h4>
                          </div>
                        </div>
                        <div class="swiper-slide">
                          <div class="ms-popular__item p-relative mb-30">
                            ...
                            <h4 class="ms-popular__title">
                              <a href="genres-details.html">Instrument4 </a>
                            </h4>
                          </div>
                        </div>
                      </div>
        ...
        <section class="ms-fun-brand ms-bg-2 pb-130 pt-125">
          <div class="container">
            <div class="row justify-content-center bdFadeUp">
              <div class="col-xl-7">
                <div
                  class="section__title-wrapper mb-65 text-center bd-title-anim"
                >
                  <span class="section__subtitle">Function Bands</span>
                  <h2 class="section__title">
                    our most
                    <span class="ms-text1">popular function</span> bands
                  </h2>
                </div>
              </div>
            </div>
            <div class="ms-fun-brand-wrap bdFadeUp">
                ...
                <div class="ms-fun-brand-top mb-20">
                  ...
                  <div class="ms-fun-brand-content">
                    <h3 class="ms-fun-brand-title">
                      <a href="genres-details.html">Beastie Boys</a>
                    </h3>
              ...
              <div class="ms-fun-brand-item ms-fun-border">
                <div class="ms-fun-brand-top mb-20">
                  ...
                  <div class="ms-fun-brand-content">
                    <h3 class="ms-fun-brand-title">
                      <a href="genres-details.html">Blondie</a>
                    </h3>
                    <span class="ms-fun-brand-subtitle"
                      >American rock group</span
                    >
                  </div>
                </div>
                <div class="ms-fun-brand-bottom">
              ...
              <div class="ms-fun-brand-item ms-fun-border">
                <div class="ms-fun-brand-top mb-20">
                  ...
                  <div class="ms-fun-brand-content">
                    <h3 class="ms-fun-brand-title">
                      <a href="genres-details.html">Black Sabbath</a>
                    </h3>
                    <span class="ms-fun-brand-subtitle"
                      >British rock group</span
                    >
                  </div>
                </div>
                <div class="ms-fun-brand-bottom">
                  <div class="ms-fun-brand-location">
                    <a href="https://www.google.com/maps" target="_blank">
                      <i class="flaticon-pin"></i>London</a
                    >
                  </div>
                  <div class="ms-fun-brand-rating">
                    <i class="flaticon-star"></i>
              ...
              <div class="ms-fun-brand-item ms-fun-border">
                <div class="ms-fun-brand-top mb-20">
                  ...
                  <div class="ms-fun-brand-content">
                    <h3 class="ms-fun-brand-title">
                      <a href="genres-details.html">The Coasters</a>
                    </h3>
              ...
              <div class="ms-fun-brand-item ms-fun-border">
                ...
                <div class="ms-fun-brand-bottom">
                  <div class="ms-fun-brand-location">
                    <a href="https://www.google.com/maps" target="_blank">
                      <i class="flaticon-pin"></i>City Club</a
                    >
                  </div>
                  <div class="ms-fun-brand-rating">
                    <i class="flaticon-star"></i>
              ...
              <div class="ms-fun-brand-item ms-fun-border">
                ...
                <div class="ms-fun-brand-bottom">
                  <div class="ms-fun-brand-location">
                    <a href="https://www.google.com/maps" target="_blank">
                      <i class="flaticon-pin"></i>Kenia</a
                    >
                  </div>
                  <div class="ms-fun-brand-rating">
                    <i class="flaticon-star"></i>
              ...
              <div class="ms-fun-brand-item ms-fun-border">
                ...
                <div class="ms-fun-brand-bottom">
                  <div class="ms-fun-brand-location">
                    <a href="https://www.google.com/maps" target="_blank">
                      <i class="flaticon-pin"></i>Pakistan</a
                    >
                  </div>
                  <div class="ms-fun-brand-rating">
                    <i class="flaticon-star"></i>
        ...
        <section
          class="ms-event2-area include__bg zindex-1 p-relative pt-140 pb-105"
          data-background="assets/img/event/event-bg-3.png"
        >
          <div class="ms-overlay ms-overlay1 zindex--1"></div>
          <div class="container">
            <div class="row justify-content-center mb-20 bdFadeUp">
              <div class="col-xl-6">
                <div class="ms-event2-top text-center">
                  <div class="ms-event2 mb-40">
                    <a
                      class="ms-round2-btn popup-video"
                      href="https://www.youtube.com/watch?v=ZrACEetKEjU"
                  ...
                  <div class="section__title-wrapper mb-40 bd-title-anim">
                    ...
                    <h2 class="section__title">
                      Special <span class="ms-text1">event</span>
                      coming up
                    </h2>
                  </div>
                </div>
            ...
            <div class="row bdFadeUp">
              <div class="col-lg-6">
                <div class="ms-event2-item mb-25">
                  <h3 class="ms-event-title">
                    <a href="event-details.html">Wedding entertainment ideas</a>
                  </h3>
                ...
                <div class="ms-event2-item mb-25">
                  <h3 class="ms-event-title">
                    <a href="event-details.html"
                      >Corporate entertainment ideas</a
                    >
                  </h3>
                  <p class="ms-event-text">
                    Our hand-picked acts will guarantee you fantastic wedding
              ...
              <div class="col-lg-6">
                <div class="ms-event2-item mb-25">
                  <h3 class="ms-event-title">
                    <a href="event-details.html">New Year’s Eve party bands</a>
                  </h3>
                  <p class="ms-event-text">
                    Our hand-picked acts will guarantee you fantastic wedding
                    entertainment for each part. We'll provide help and support
            ...
            <div class="row align-items-end mb-25 bdFadeUp">
              <div class="col-lg-8">
                <div class="section__title-wrapper mb-40 bd-title-anim">
                  ...
                  <h2 class="section__title">
                    Most <span class="ms-text1">Trending genres</span>
                  </h2>
                </div>
              </div>
              <div class="col-lg-4">
            ...
            <div class="row ms-trending3-wrap bdFadeUp">
              <div class="col-xl-4 col-md-6">
                <div class="ms-trending3-item p-relative fix mb-40">
                  <div
                    class="ms-trending3-img w-img ms-br-15 p-relative fix mb-30"
                  >
                    <a href="genres-details.html"
                      ><img
                        src="assets/img/trending/01.jpg"
                        alt="trending image"
                    /></a>
                    <div class="trending__arrow">
                      <a href="assets/img/trending/01.jpg" class="popup-image"
                        ><i class="fa-regular fa-arrow-right-long"></i
                      ></a>
                    </div>
                  ...
                  <div class="ms-trending3-content">
                    <h3 class="ms-trending3-title mb-25">
                      <a href="genres-details.html">Party bands for hire</a>
                    </h3>
                    <p class="ms-trending3-text">
                      Party Bands For Hire a Live Music Agency offering an
                      unknown printer took a galley wtnd scrambled.
                    </p>
                  </div>
                </div>
              </div>
              <div class="col-xl-4 col-md-6">
                <div class="ms-trending3-item p-relative fix mb-40">
                  ...
                  >
                    <a href="genres-details.html"
                      ><img
                        src="assets/img/trending/02.jpg"
                        alt="trending image"
                    /></a>
                    <div class="trending__arrow">
                      <a href="assets/img/trending/02.jpg" class="popup-image"
                        ><i class="fa-regular fa-arrow-right-long"></i
                      ></a>
                    </div>
                    <span class="trending__title">Musicly</span>
              ...
              <div class="col-xl-4 col-md-6">
                <div class="ms-trending3-item p-relative fix mb-40">
                  ...
                  >
                    <a href="genres-details.html"
                      ><img
                        src="assets/img/trending/03.jpg"
                        alt="trending image"
                    /></a>
                    <div class="trending__arrow">
                      <a href="assets/img/trending/03.jpg" class="popup-image"
                        ><i class="fa-regular fa-arrow-right-long"></i
                      ></a>
                    </div>
                    <span class="trending__title">Musicly</span>
        ...
        <section class="ms-tm2-area p-relative fix pt-10 pb-125">
          <div class="ms-tm2-line p-absolute">
            <img
              src="assets/img/testimonial/testimonial-line.png"
          ...
          <div class="container">
            <div class="row justify-content-center bdFadeUp">
              <div class="col-xl-6">
                <div
                  class="section__title-wrapper text-center mb-65 bd-title-anim"
                >
                  <span class="section__subtitle">Awesome Feedbacks</span>
                  <h2 class="section__title">
                    Peoples <span class="ms-text1">Think</span> About us
                  </h2>
                </div>
              </div>
            </div>
          ...
          <div class="container">
            <div class="ms-tm2-imgs-wrap p-relative">
              <div
                class="ms-tm2-img1 ms-tm2-shadow p-absolute w-img d-none d-md-block"
              >
                <img
                  src="assets/img/testimonial/testimonial-07.png"
                  alt="testimonial image"
                />
              </div>
              <div
                class="ms-tm2-img2 ms-tm2-shadow p-absolute w-img d-none d-lg-block"
              >
                <img
                  src="assets/img/testimonial/testimonial-08.png"
                  alt="testimonial image"
                />
              </div>
              <div
                class="ms-tm2-img3 ms-tm2-shadow p-absolute w-img d-none d-xl-block"
              >
                <img
                  src="assets/img/testimonial/testimonial-09.png"
                  alt="testimonial image"
                />
              </div>
              <div
                class="ms-tm2-img4 ms-tm2-shadow p-absolute w-img d-none d-md-block"
              >
                <img
                  src="assets/img/testimonial/testimonial-10.png"
                  alt="testimonial image"
                />
              </div>
              <div
                class="ms-tm2-img5 ms-tm2-shadow p-absolute w-img d-none d-lg-block"
              >
                <img
                  src="assets/img/testimonial/testimonial-11.png"
                  alt="testimonial image"
                />
              </div>
              <div
                class="ms-tm2-img6 ms-tm2-shadow p-absolute w-img d-none d-xl-block"
              >
                <img
                  src="assets/img/testimonial/testimonial-12.png"
                  alt="testimonial image"
                />
              </div>
              <div class="row justify-content-center bdFadeUp">
                    ...
                    <div class="ms-tm2-active mb-60">
                      <div class="ms-tm2-item text-center">
                        <div class="ms-tm2-img-main">
                          <div
                            class="ms-tm2-img-wrap p-relative d-inline-block mx-auto"
                          >
                            <div class="ms-tm2-signature w-img">
                              <img
                                src="assets/img/testimonial/testimonial-signature.png"
                                alt="testimonial signature"
                              />
                            </div>
                            <div class="ms-tm2-author-img m-img">
                              <img
                                src=" assets/img/testimonial/testimonial-06.png"
                                alt="testimonial image"
                              />
                            </div>
                          </div>
                          <div class="ms-tm2-content pt-35">
                            ...
                            <p class="ms-tm2-text mb-30">
                              It is a sequence of Latin words that, as they are
                              positioned, do not form sentences with a complete
                              sense, but give life to a test text useful to fill
                              spaces that will subsequently be occupied from ad
                              hoc texts composed by communication professionals.
                            </p>
                            <div class="ms-tm2-author">
                              <span class="ms-tm2-name">Dio Caprio</span>
                              <span class="ms-tm2-designation"
                                >CEO - XYZ Innovation</span
                              >
                            </div>
                          </div>
                        </div>
        ...
        <section class="ms-news3-area ms-bg-2 p-relative fix pt-130 pb-90">
          <div class="container">
            <div class="row justify-content-center bdFadeUp">
              <div class="col-xl-6">
                <div
                  class="section__title-wrapper text-center mb-25 bd-title-anim"
                >
                  <span class="section__subtitle">Latest News</span>
                  <h2 class="section__title">
                    <span class="ms-text1">Musicly</span>
                    Morning Insight
                  </h2>
                </div>
              </div>
            ...
            <div class="swiper-container ms-news3-active">
              <div class="ms-news3-slick">
                <div class="ms-news3-item p-relative">
                  <a class="ms-news3-cat" href="news-details.html">Event</a>
                  <h3 class="ms-news3-title">
                    <a href="news-details.html"
                      >What's more, our live music To The guaran tee means
                      that</a
                    >
                  </h3>
                  <div class="ms-news-meta">
                    <ul>
                      ...
                      <li><a href="news-details.html">0 Comments</a></li>
                    </ul>
                  </div>
                  <div class="ms-news3-img w-img ms-br-15 fix">
                    <a href="news-details.html"
                      ><img src="assets/img/news/news-01.png" alt="news image"
                    /></a>
                  </div>
                </div>
              </div>
              <div class="ms-news3-slick">
                <div class="ms-news3-item p-relative">
                  <a class="ms-news3-cat" href="news-details.html"
                    >Wedding Party</a
                  >
                  <h3 class="ms-news3-title">
                    <a href="news-details.html"
                      >The first dance as a married couple has become</a
                    >
                  </h3>
                  <div class="ms-news-meta">
                    <ul>
                      <li><span>Mar 01, 2023, 2023</span></li>
                      <li><a href="news-details.html">10 Comments</a></li>
                    </ul>
                  </div>
                  <div class="ms-news3-img w-img ms-br-15 fix">
                    <a href="news-details.html"
                      ><img src="assets/img/news/news-02.png" alt="news image"
                    /></a>
                  </div>
                </div>
              </div>
              <div class="ms-news3-slick">
                <div class="ms-news3-item p-relative">
                  ...
                  <h3 class="ms-news3-title">
                    <a href="news-details.html"
                      >Our exclusive range of live bands for hire have
                      experience</a
                    >
                  </h3>
                  <div class="ms-news-meta">
                    <ul>
                      ...
                      <li><a href="news-details.html">20 Comments</a></li>
                    </ul>
                  </div>
                  <div class="ms-news3-img w-img ms-br-15 fix">
                    <a href="news-details.html"
                      ><img src="assets/img/news/news-03.png" alt="news image"
                    /></a>
                  </div>
                </div>
              </div>
                ...
                <div class="ms-news3-item p-relative">
                  ...
                  <div class="ms-news-meta">
                    <ul>
                      ...
                      <li><a href="news-details.html">05 Comments</a></li>
                    </ul>
                  </div>
                  <div class="ms-news3-img w-img ms-br-15 fix">
                    <a href="news-details.html"
              ...
              <div class="ms-cta-wrap">
                <div class="ms-cta-item">
                  <div class="ms-cta-content">
                    <h2 class="section__title mb-25">
                      Best way to Hire to Musician
                    </h2>
                    <p class="mb-0">
                      Party Bands For Hire a Live Music Agency offering an
                      unknown printer took a galley wtnd scrambled it to makeive
                      centuriesbut also.
                    </p>
                  </div>
                </div>
                ...
                <div class="ms-cta-item">
                  <div class="ms-cta-app">
                    <a target="_blank" href="#"
                      ><img src="assets/img/cta/app-store.png" alt="app store"
                    /></a>
                    <a target="_blank" href="#"
                      ><img
                        src="assets/img/cta/play-store.png"
                        alt="play store"
                    /></a>
                  </div>
                </div>
      ...
      <footer>
        <div
          class="ms-footer3-wrap include__bg zindex-1 p-relative"
            ...
            <div class="container">
              <div class="ms-border2">
                <div class="ms-footer2-logo mb-130 mx-auto">
                  <a href="index.html"
                    ><img
                      src="assets/img/logo/footer3-logo.png"
                      alt="footer logo"
                  /></a>
                </div>
                <div
                  class="ms-footer2-top-inner ms-border1 ms-br-100 ms-bg-4 mb-65"
                >
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <div class="ms-footer2-rating three mb-10">
                        <h3>
                          ...
                          <a href="#"
                            ><img
                              src="assets/img/footer/start-01.png"
                              alt="footer image"
                          /></a>
                        </h3>
                      </div>
                    ...
                    <div class="col-lg-6">
                      <div
                        class="ms-subscribe2-form p-relative mb-10 d-none d-sm-block"
                      >
                        <i class="flaticon-mail"></i>
                        <input type="text" placeholder="Enter your mail" />
                        <button type="submit" class="ms-subscribe2-btn">
                          Subscribe Now
                      ...
                      <div
                        class="ms-subscribe2-mobile p-relative mb-10 d-sm-none"
                      >
                        <i class="flaticon-mail"></i>
                        <input type="text" placeholder="Enter your mail" />
                        <button type="submit" class="ms-subscribe2-m-btn">
                          Subscribe Now
                          <i class="fa-sharp fa-solid fa-paper-plane"></i>
                        </button>
                      </div>
                      ...
                      <div class="ms-footer2-contact border-0 pb-40">
                        <ul>
                          <li>
                            ...
                            ><a href="#"
                              >936 Kuhl Avenue, Norcross, Georgia GA 5983,
                              United State</a
                            >
                          </li>
                          <li>
                            <i class="flaticon-phone-call"></i
                            ><a href="tel:03332920560">0333 292 0560</a>
                          </li>
                          <li>
                            <i class="flaticon-mail"></i
                            ><a href="mailto:info@musiclycontact.com"
                              >info@musiclycontact.com</a
                            >
                          </li>
                        </ul>
                      </div>
                  ...
                  <div class="col-xxl-2 col-lg-3 col-md-6">
                    <div class="ms-footer2-widget mb-50">
                      ...
                      <ul>
                        ...
                        <li>
                          <a href="genres-details.html">Classical Musician</a>
                        </li>
                        <li>
                          <a href="genres-details.html">Corporate Party</a>
                        </li>
                        <li>
                          <a href="genres-details.html">Premiere Party Band</a>
                        </li>
