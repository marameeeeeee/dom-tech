...
<head>
    ...
    <style>
        ...
        nav a {
            ...
            display: block;
            padding: 12px 25px; /* padding pour l'espace autour du texte */
            border-radius: 4px;
...
.admin-access-section {
        ...
        .admin-access-section a:hover {
            background-color: #0056b3;
        }

        /* Modifier les couleurs des liens dans la section d'administration */
        .admin-access-section a {
        ...
        /* Reset des styles pour la cohérence */
        * {
            margin: 0;
            padding: 0;
            box-sizing: border-box;
...
<body>
    <header>
        <nav>
            <ul>
            <li><a href="test.php">List Users</a></li>
            <li><a href="listtypes.php">List types d instruments </a> </li>
            <li><a href="lisinstruments.php">List d instruments </a></li>
            <li><a href="avis.php">Voir les avis</a> </li><!-- Ajout du lien pour afficher les avis -->
            <li><a href="listRdvs.php">List des rendez_vous</a></li>
            <li><a href="stat.php">demande des rendez_vous</a></li>
                    <li><a href="Filtrage.php">page de recherche des rendez vous</a></li>
                    <li><a href="listEvenementtypes.php">liste types evenements</a></li>
                    <li><a href="listEvenement.php">liste  evenements</a></li>
                    <li><a href="indexx.php">statistique par mois </a></li>
                    <li><a href="ListAbonnement.php">list abonnement</a></li>
                    <li><a href="ListPack.php">list packs</a></li>
                    <li><a href="statistics.php">statistique des abonnements</a></li>
                    <li><a href="searchAbonnement.php">rechercher d abonnement</a></li>
                    <li><a href="listCourstypes.php">liste des cours</a></li>
            </ul>
        </nav>
    </header>
    ...
    $stmt = $pdo->prepare("SELECT image_path, id FROM user_images WHERE user_id = ?");
    $stmt->execute([$id]);
    ...
    foreach ($images as $image) {
        ...
        // Récupérer le nombre de likes pour chaque image
