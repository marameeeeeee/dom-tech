...
def send_email(receiver_email, link):
    ...
    sender_email = 'maram.omezzine@esprit.tn'  # Remplacez par votre adresse e-mail Gmail
    password = 'noqh lmzs aoeu ykbb'  # Remplacez par votre mot de passe Gmail
...
dest_email = 'abdelhakfadwa8@gmail.com'  # Remplacez par l'adresse e-mail du destinataire
